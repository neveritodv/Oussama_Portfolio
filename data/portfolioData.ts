...
export const PORTFOLIO_DATA = {
  ...
  experiences: [
    ...
    },
    {
      ...
      description: [
        "Architected and engineered the 'Job Hunter' recruitment platform, including a multi-role mobile app (Flutter) and modular backend service (NestJS).",
        "Implemented strict multi-company tenant data isolation using authenticated JWT identity and ownership-based database queries.",
        "Created candidate marketplace allowing candidates to publish job-seeking posts and manage profiles with full lifecycle controls.",
        "Built robust JWT authentication, role-based access control, secure OTP-based password recovery, and email verification.",
        "Handled duplicate hiring requests with a graceful 409 Conflict check in the backend and SnackBar handling in Flutter.",
        "Wrote automated backend Jest tests (27/27 suites, 72/72 tests passed) and Flutter widget/integration tests (205/205 passed).",
      ],
      skillsUsed: [
        "Flutter",
        "NestJS",
  ...
  projects: [
...

    {
      ...
      number: "09",
      title: "Job Hunter",
      subtitle: "Full-Stack Recruitment & Candidate Hiring Platform",
      category: "Full Stack / Mobile",
      clientOrRole: "Full-Stack Personal Project",
      description:
        "A complete recruitment platform connecting companies and candidates through secure authentication, job discovery, applications, candidate job-seeking posts, and hiring requests.",
      longDescription:
        "Job Hunter is a full-stack recruitment platform built with Flutter and NestJS. It connects candidates and companies through role-based workflows, secure authentication, job discovery, applications, candidate marketplace posts, and hiring requests. The platform includes password recovery with OTP verification, email verification, JWT authentication, protected routes, role-based access control, Prisma ORM, PostgreSQL, and a responsive Flutter architecture using Riverpod and Dio.",
      techStack: [
        "Flutter",
        "Dart",
        "NestJS",
      ...
      keyHighlights: [
        "Multi-role recruitment platform for Candidates and Companies",
        "Secure JWT authentication and role-based authorization",
        "Email verification and OTP password recovery",
        "Candidate Job-Seeking Marketplace",
        "Companies can discover candidates and send hiring requests",
        "Candidate post lifecycle: Draft / Published / Closed",
        "Advanced candidate filtering by skills, location, work mode, employment type, salary and experience",
        "PostgreSQL database with Prisma ORM",
        "Strict multi-company tenant data isolation",
        "Flutter architecture with Riverpod, Dio and GoRouter",
        "Comprehensive backend and Flutter automated testing",
      ],
      architecture: [
        "Frontend: Flutter + Dart + Riverpod + Dio + GoRouter",
        "Backend: NestJS + TypeScript + REST API",
        "Database: PostgreSQL + Prisma ORM",
        "Authentication: JWT + bcrypt + OTP + email verification",
        "Email: Nodemailer / SMTP",
        "Testing: Jest + Flutter Widget/Integration Tests",
      ],
      previewUrl: "#",
      githubUrl: "https://github.com/neveritodv/IA_mobile_joob_hunter.git",
      imageCol1: "/assets/job_hunter_1.jpg",
      imageCol2: "/assets/job_hunter_2.jpg",
      imageCol3: "/assets/job_hunter_3.jpg",
      bannerColor: "from-slate-950 via-blue-950 to-indigo-950",
    },
  ],
};
